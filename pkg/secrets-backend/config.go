...
// Namespace Namespace for secrets.  Might map to an org such as 'core-infra', 'core-platform', or 'core-services', but also may not.  Maps directly to a Namespace in K8s.
...
// LoadOrgData Create an Org interface from yaml
func LoadOrgData(data []byte) (ns Namespace, err error) {
